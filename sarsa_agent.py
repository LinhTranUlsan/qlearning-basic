...
class SARSAAgent:
    ...
    def update_q_value(self, state, action, reward, next_state, next_action):
        ...
        next_q = self.q_table[next_state, next_action]  # SARSA uses actual next action
    ...
    def save_q_table(self, filename='sarsa_q_table.npy'):
        """Save Q-table to file"""
        np.save(filename, self.q_table)
        print(f"SARSA Q-table saved to {filename}")
    
    def load_q_table(self, filename='sarsa_q_table.npy'):
